...
const editPostSchema = z.object({
  caption: z.string().max(500, {message: 'Caption must be less than 500 characters'})
})
...
const EditPostForm = ({post} : {post: PostDataOutput}) => {
  ...
  return (
    <Form {...editPostForm}>
      <form onSubmit={editPostForm.handleSubmit(onSubmit)} className='space-y-8 w-full'>
        <FormField
